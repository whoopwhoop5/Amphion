...
# Preset: Seed-VC whisper-base-f0 44k (FT EMA) on FLEURS fr_fr.
#
# Usage:
#   MAX_PAIRS=50 bash scripts/vc_quest/presets/seedvc_fleurs_fr_whisper_base_f0_44k_ft_ema.sh

cd "$(dirname "$0")/../../.."

export RUN_NAME="${RUN_NAME:-seedvc_whisper_base_f0_44k_ft_ema_w300_h300}"

export HF_CHECKPOINT_NAME="DiT_seed_v2_uvit_whisper_base_f0_44k_bigvgan_pruned_ft_ema.pth"
